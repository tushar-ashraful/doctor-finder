...
<div class="left-sidenav">
    ...
    <div class="main-menu-inner">
        <div class="menu-body slimscroll">
            <div id="MetricaAnalytic" class="main-icon-menu-pane {{ request()->is('dashboard/category/*') ? 'active' : '' }}">
                <div class="title-box">
                    <h6 class="menu-title">Analytics</h6>
                </div>
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ route('backend.dashboard') }}"><i class="dripicons-meter"></i>Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->is('dashboard/category/*') ? 'active' : '' }}" href="{{ route('backend.category.index') }}"><i class="dripicons-user-group"></i>Specialities</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->is('dashboard/doctor/*') ? 'active' : '' }}" href="{{ route('backend.doctor.index') }}"><i class="dripicons-user-group"></i>Doctor</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->is('dashboard/booking/*') ? 'active' : '' }}" href="{{ route('backend.booking.index') }}"><i class="dripicons-user-group"></i>Doctor Appointment List</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->is('dashboard/contact/*') ? 'active' : '' }}" href="{{ route('backend.contact.index') }}"><i class="dripicons-user-group"></i>Contact</a></li>
                </ul>
            </div>
            <!-- end Analytic -->
            <div id="MetricaCrypto" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="../crypto/crypto-index.html"><i class="dripicons-device-desktop"></i>Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="../crypto/crypto-exchange.html"><i class="dripicons-swap"></i>Exchange</a></li>
                    <li class="nav-item"><a class="nav-link" href="../crypto/crypto-wallet.html"><i class="dripicons-wallet"></i>My Wallet</a></li>
                    <li class="nav-item"><a class="nav-link" href="../crypto/crypto-calendar.html"><i class="dripicons-calendar"></i>Calendar</a></li>
                    <li class="nav-item"><a class="nav-link" href="../crypto/crypto-news.html"><i class="dripicons-blog"></i>Crypto News</a></li>
                    <li class="nav-item"><a class="nav-link" href="../crypto/crypto-ico.html"><i class="dripicons-stack"></i>ICO List</a></li>
                    <li class="nav-item"><a class="nav-link" href="../crypto/crypto-settings.html"><i class="dripicons-gear"></i>Settings</a></li>
                </ul>
            </div>
            <!-- end Crypto -->
            <div id="MetricaProject" class="main-icon-menu-pane {{ request()->is('dashboard/project/*','dashboard/mywork/*','dashboard/work/*','dashboard/university/*') ? 'active' : '' }}">
                <div class="title-box">
                    <h6 class="menu-title">Projects</h6>
                </div>
                <ul class="nav">
                    {{-- <li class="nav-item"><a class="nav-link {{ request()->is('dashboard/project/*') ? 'active' : '' }}" href="{{ route('backend.project.index') }}"><i class="dripicons-view-thumb"></i>Projects</a></li> --}}
                   {{--  <li class="nav-item"><a class="nav-link" href="../projects/projects-clients.html"><i class="dripicons-user-id"></i>Clients</a></li>
                    ...
                    {{-- <li class="nav-item"><a class="nav-link {{ request()->is('dashboard/mywork/*') ? 'active' : '' }}" href="{{ route('backend.mywork.index') }}"><i class="dripicons-checklist"></i>My Work</a></li> --}}
                    {{-- <li class="nav-item"><a class="nav-link {{ request()->is('dashboard/university/*') ? 'active' : '' }}" href="{{ route('backend.university.index') }}"><i class="dripicons-checklist"></i>University</a></li> --}}
            ...
            <div id="MetricaEcommerce" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="ecommerce-index.html"><i class="dripicons-device-desktop"></i>Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="ecommerce-products.html"><i class="dripicons-view-apps"></i>Products</a></li>
                    <li class="nav-item"><a class="nav-link" href="ecommerce-product-list.html"><i class="dripicons-list"></i>Product List</a></li>
                    <li class="nav-item"><a class="nav-link" href="ecommerce-product-detail.html"><i class="dripicons-article"></i>Product Detail</a></li>
                    <li class="nav-item"><a class="nav-link" href="ecommerce-cart.html"><i class="dripicons-cart"></i>Cart</a></li>
                    <li class="nav-item"><a class="nav-link" href="ecommerce-checkout.html"><i class="dripicons-card"></i>Checkout</a></li>
                </ul>
            </div>
            <!-- end Ecommerce -->
            ...
            <div id="MetricaOthers" class="main-icon-menu-pane">
                ...
                <ul class="nav metismenu" id="main_menu_side_nav">
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-mail"></i><span class="w-100">Email</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-view-thumb"></i><span class="w-100">UI Elements</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-anchor"></i><span class="w-100">Advanced UI</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-document"></i><span class="w-100">Forms</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-graph-line"></i><span class="w-100">Charts</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-view-list-large"></i><span class="w-100">Tables</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-headset"></i><span class="w-100">Icons</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-map"></i><span class="w-100">Maps</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <!--end nav-item-->
                    <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-article"></i><span class="w-100">Email Templates</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
            ...
            <!-- end Pages -->
            <div id="MetricaAuthentication" class="main-icon-menu-pane {{ request()->is('dashboard/user/*') ? 'active' : '' }}" >
                <div class="title-box">
                    <h6 class="menu-title">Authentication</h6>
                </div>
                <ul class="nav">
                    <li class="nav-item "><a class="nav-link {{ request()->is('dashboard/user/*') ? 'active' : '' }}" href="{{ route('backend.user.index') }}"><i class="dripicons-user-group"></i>Users</a></li>
