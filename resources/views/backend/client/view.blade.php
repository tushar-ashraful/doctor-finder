...
@section('content')
    <div class="container-fluid">
        <x-backend.breadcrumb>
            <li class="breadcrumb-item active"><a href="{{ route('backend.user.index') }}">Users</a></li>
                                ...
                                <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                                    <div class="met-profile-main">
                                        <div class="met-profile-main-pic">
                                            <img src="{{ asset('contents/backend') }}/assets/images/users/user-4.jpg" alt="" class="rounded-circle">
