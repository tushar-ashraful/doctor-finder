...
<div class="row justify-content-center">
    <div class="col-10">
        <x-backend.from fromAction="{{ route('backend.category.update',$category->id) }}" fromMethod='PUT' fromClass=''>
            <x-slot name='fromBody'>
                <div class="card mb-0">
                    <div class="card-header">
                        <h4 class="mt-2 header-title text-dark float-left">Edit Category </h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='code'  inputRequired='true' inputValue='{{ $category->code }}' />
                            </div>
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='name'  inputRequired='true' inputValue='{{ $category->name }}' />
                            </div>
