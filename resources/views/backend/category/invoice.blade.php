                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->item->name }} <br>
                                            @if ($item->upgrade_at)
                                            ( Upgrade: <span title="Upgrade Create Date">{{ myDateTime($item->upgrade_at) }}</span>)
                                            <br>
                                            @elseif ($item->correction_at)
                                             ( Correction: <span title="Correction Create Date">{{ myDateTime($item->correction_at) }}</span>)
                                            @endif
                                        </td>
                                   ...
                                   @if ( ($project->return_at || $project->cancel_at) && ($project->return_amount !=0) )
                                        <tr>                                                        
                                            <td colspan="4" class="border-0"style="border:none !important;padding:4px 12px;"></td>
