                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='supervisor_phone' inputType='number' inputRequired='true'/>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="repeater-custom-show-hide col-md-12 mb-3">
                                <div data-repeater-list="members">
                                    <div data-repeater-item="" class="row">
                                        ...
                                        <div class="col-md-3">
                                            <x-backend.inputs.input inputName='member_phone'/>
                                        </div>
                                        <div class="col-md-1">
                            ...
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='phone' inputType='number' inputRequired='true'/>
                            </div>
                            <div class="col-md-6">
