...
<div class="row justify-content-center">
    <div class="col-10">
        <x-backend.from fromAction="{{ route('backend.project.store') }}" fromMethod='POST' fromClass=''>
            <x-slot name='fromBody'>
                <div class="card mb-0">
                    <div class="card-header">
                        <h4 class="mt-2 header-title text-dark float-left">Create Project ( <b>{{ $newSku }}</b> )</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='title'  inputRequired='true' />
                            </div>
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='reference' />
                            </div>
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='supervisor' inputRequired='true'/>
                            </div>
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='supervisor_phone' inputType='tel' inputRequired='true'/>
                            </div>
                            <div class="col-md-12">
                                <x-backend.inputs.input inputName='description' inputType='textarea'/>
                            </div>
                            <div class="col-md-3">
                                <x-backend.inputs.input inputName='delivery' inputType='date' inputRequired='true'/>
                            </div>
                            <div class="col-md-2 align-self-center">
                                <div class="custom-control custom-switch switch-danger ">
                                    <input type="checkbox" class="custom-control-input" name='is_urgent' id="customSwitchDanger">
                            ...
                            <div class="repeater-custom-show-hide col-md-12 mb-3">
                                <div data-repeater-list="members">
                                    <div data-repeater-item="" class="row">
                                        <div class="col-md-4">
                                            <x-backend.inputs.input inputName='member_name'/>
                                        </div>
                                        <div class="col-md-4">
                                            <x-backend.inputs.input inputName='member_id'/>
                                        </div>
                                        <div class="col-md-3">
                                            <x-backend.inputs.input inputName='member_phone' inputType='tel'/>
                                        </div>
                                        <div class="col-md-1">
                            ...
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='phone' inputType='tel' inputRequired='true'/>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='batch' inputRequired='true'/>
                            </div>
                            <div class="col-md-6">
                                <x-backend.inputs.input inputName='address' inputRequired='true'/>
                            </div>
                            <div class="col-md-12">
                                <h4>Payment Info</h4>
                                <hr>
