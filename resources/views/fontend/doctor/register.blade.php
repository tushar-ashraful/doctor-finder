                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-md-12 col-lg-6 login-right">
                                        <div class="login-header">
                                            <h3>Doctor Registration <a href="{{ route('website.patient.register') }}">Patient Registration</a></h3>
                                        </div>
                                        <form action="{{ route('website.doctor.register.submit') }}" method="post">
                                            @csrf
                                            ...
                                            <div class="text-start">
                                                <a class="forgot-link" href="{{ route('website.doctor.login') }}">Already have an account?</a>
                                            </div>
