                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-12 col-lg-6 login-right">
                            <div class="login-header">
                                <h3>Patient Login <a href="{{ route('website.doctor.login') }}">Doctor Login</a></h3>
                            </div>
                            <form action="{{ route('website.patient.login.submit') }}" method="post">
                                @csrf
                                ...
                                <div class="text-center dont-have">Don’t have an account? <a href="{{ route('website.patient.register') }}">Register</a></div>
                            </form>
                        </div>
                    </div>
                </div>
